  ...
  return (
    <section className="dress-code py-16 md:py-20" id="dress-code">
      <div className="container flex justify-center">
        ...
        >
          <h2
            className="text-xl md:text-2xl uppercase tracking-[0.2em] text-[#2C3E50] mb-4 md:mb-6 text-center"
          ...
          <div className="flex-1 min-w-0 text-center px-2 md:px-6">
            <p
              className="text-[#2C3E50]/90 text-xs md:text-base leading-snug md:leading-relaxed mb-3 md:mb-6"
              style={{ fontFamily: "'Playfair Display', serif" }}
            >
